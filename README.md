...
When you edit the text of `MathTextView` the underlying LaTeX codes will show which you can edit to your liking. As soon as you finish editing the formatted equations will be shown again, so you can instantly see if your edits were successful.
